...
//COLOUR SENSOR
#define CS_M_POW 49
#define CS_M_OE 41 // middle colour sensor
#define CS_M_S0 39
#define CS_M_S1 37
#define CS_M_S2 45
#define CS_M_S3 43
...
void loop(){ 
  ...
  //Serial.println(isPillarR());
  pillarIdentificationLoop();
   // Serial.println(isPillarR());
  //lineFollow();
 // gridTraverseLoop();
 // moveDistance(3000,3000);
}
